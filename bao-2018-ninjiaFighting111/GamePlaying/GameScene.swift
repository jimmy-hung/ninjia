...
//        if Int(floor(Double(score/100))) == bossCount
//        {
//            bossComing() ; bossCount += 1
//        }
        
        print("Int: \(Int(floor(Double(score/100))))")
        ...
        let batScale = CGFloat(bat.frame.width / bat.frame.height)
        ...
        bat.size.width = self.frame.size.width / 4
        ...
        skActionToGo(theNode: bat, xposition: position, animateTime: 6, ypositiion: 3.5)
    }
