...
var useUsually = UserDefaults().string(forKey: "USE") ?? "http://site-1496059-4867-4712.strikingly.com"
var author = UserDefaults().string(forKey: "Author") ?? "Jimmy"
var firstBGImg = UserDefaults().string(forKey: "IMG") ?? "https://i.screenshot.net/71k48c4"
var showText = UserDefaults().string(forKey: "Show") ?? "Are you ready ?"
var playText = UserDefaults().string(forKey: "Play") ?? "GO"
